    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 shadow-sm sm:rounded-lg px-5 py-7">
                <h1 class="text-3xl text-center	text-gray-900 dark:text-gray-100">{{__('coupons.admin.edit.title')}}</h1>
                <form method="POST" action="{{route('admin.coupons.update', $coupon->id)}}" enctype="multipart/form-data">
                    ...
                    <div class="mt-2">
                        ...
                        <x-text-input id="name" class="block mt-1 w-full" type="text" name="name" :value="old('name', $coupon->name)"
                                      required autofocus/>
                    ...
                    <div class="mt-2">
                        ...
                        <x-text-input id="sales_price" class="block mt-1 w-full" type="number" name="sales_price"
                                      :value="old('sales_price', $coupon->sales_price)" required/>
