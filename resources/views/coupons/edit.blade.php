    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 shadow-sm sm:rounded-lg px-5 py-7">
                <h1 class="text-3xl text-center	text-gray-900 dark:text-gray-100">{{__('Edit Coupon')}}</h1>
                <form method="POST" action="{{route('coupons.update', $coupon->id)}}" enctype="multipart/form-data">
                    ...
                    <div class="mt-2">
                        ...
                        <x-text-input id="name" class="block mt-1 w-full" type="text" name="coupon_name" :value="old('coupon_name', $coupon->name)"
                                      required autofocus/>
                    ...
                    <div class="mt-2">
                        ...
                        <x-textarea
                            ...
                            value="{{old('coupon_description', $coupon->coupon_description)}}"
                            required
                        />
                    ...
                    <div class="mt-2">
                        ...
                        <x-text-input id="price" class="block mt-1 w-full" type="number" name="coupon_price"
                                      :value="old('coupon_price', $coupon->price)" required/>
                    ...
                    <div class="flex flex-row gap-x-2">
                        <div class="mt-2 flex-1">
                            ...
                            <x-text-input id="start_date" class="block mt-1 w-full" type="date" name="coupon_usage_start_date"
                                          :value="old('coupon_usage_start_date', $coupon->coupon_usage_start_date)" required/>
                        ...
                        <div class="mt-2 flex-1">
                            ...
                            <x-text-input id="end_date" class="block mt-1 w-full" type="date" name="coupon_usage_end_date"
                                          :value="old('coupon_usage_end_date', $coupon->coupon_usage_end_date)" required/>
                    ...
                    <div class="flex flex-row gap-x-2">
                        <div class="mt-2 flex-1">
                            ...
                            <x-text-input id="sales_start_date" class="block mt-1 w-full" type="date" name="coupon_sale_start_date"
                                          :value="old('coupon_sale_start_date', $coupon->sale_start_date)" required/>
                        ...
                        <div class="mt-2 flex-1">
                            ...
                            <x-text-input id="sales_end_date" class="block mt-1 w-full" type="date" name="coupon_sale_end_date"
                                          :value="old('coupon_sale_end_date', $coupon->sale_end_date)" required/>
                    ...
                    <div class="mt-2">
                        ...
                        <x-text-input id="coupons_available" class="block mt-1 w-full" type="number" name="coupons_available"
                                      :value="old('coupons_available', $coupon->coupons_available)"/>
