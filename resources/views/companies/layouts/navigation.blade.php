<nav x-data="{ open: false }" class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
            ...
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    <x-nav-link :href="route('admin.tournaments.index')" :active="request()->routeIs('admin.tournaments.index')">
                        {{ __('navigation.tournaments') }}
                    </x-nav-link>
                    <x-nav-link :href="route('admin.withdraws.index')" :active="request()->routeIs('admin.withdraws.index')">
                        {{ __('navigation.withdraws') }}
                    </x-nav-link>
                    <x-nav-link :href="route('admin.coupons.index')" :active="request()->routeIs('admin.coupons.index')">
                        {{ __('navigation.coupons') }}
                    </x-nav-link>
                    ...
                    <x-slot name="content">
                        <form method="POST" action="{{ route('admin.locale') }}">
                            ...
                            <x-dropdown-link :href="route('admin.logout')"
                                ...
                                <input type="hidden" name="locale" value="{{ app()->getLocale() === "jp" ? "en" : "jp"}}">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('admin.games.index')" :active="request()->routeIs('admin.users.index')">
                {{ __('navigation.users') }}
            </x-responsive-nav-link>
            ...
            <x-responsive-nav-link :href="route('admin.withdraws.index')" :active="request()->routeIs('admin.withdraws.index')">
                {{ __('navigation.withdraws') }}
            </x-responsive-nav-link>
            <x-responsive-nav-link :href="route('admin.coupons.index')" :active="request()->routeIs('admin.coupons.index')">
                {{ __('navigation.coupons') }}
            </x-responsive-nav-link>
        ...
        <div class="pt-4 pb-1 border-t border-gray-200 dark:border-gray-600">
            ...
            <div class="mt-3 space-y-1">
                <form method="POST" action="{{ route('admin.locale') }}">
                    ...
                    <x-responsive-nav-link :href="route('admin.locale')"
                            onclick="event.preventDefault();
                                        this.closest('form').submit();">
                        <input type="hidden" name="locale" value="{{ app()->getLocale() === "jp" ? "en" : "jp"}}">
                        {{ app()->getLocale() === "jp" ? "English" : "Japanese"}}
